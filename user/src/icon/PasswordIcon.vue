    ...
    <svg viewBox="0 0 24 24" class="Icon">
        <g>
            <path
                ...
                fill="gray" opacity="1" data-original="#000000" class=""></path>
        </g>
    </svg>
</template>
...
<!-- https://www.flaticon.com/free-icon/padlock_3064155?term=password&page=1&position=4&origin=search&related_id=3064155 -->